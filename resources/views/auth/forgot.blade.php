        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-3">
                ...
                <div class="password-wrapper">
                    <input type="password" name="password" id="passwordBaru" class="form-control rounded-pill" placeholder="Minimal 8 karakter" required>
                    <span class="password-toggle" onclick="togglePassword('passwordBaru')">
            ...
            <div class="mb-3">
                ...
                <div class="password-wrapper">
                    <input type="password" name="password_confirmation" id="passwordConfirm" class="form-control rounded-pill" required>
